            ...
            <div class="w3-twothird">
                ...
                <div class="w3-container w3-card w3-white w3-margin-bottom">
                    ...
                    <div class="w3-container">
                        ...
                        <textarea name="textarea" placeholder="Enter your info here for the users to see it" cols="30" rows="10"></textarea>
                        <br>
                        <button name="info">Add info</button>
                        </form>                    
                        <?php
                        ...
                        <br>
                        <form action="profile.php" method="POST">
                        <textarea name="textarea" placeholder="Enter the new info here" cols="30" rows="10"></textarea>
                        <br>
                        <button name="info">Edit info</button>
                        </form> 
                        <?php } ?>
                        <hr>
                    </div>
